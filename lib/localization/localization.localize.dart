...
abstract class _$AppLocalizeBase {
  ...
  String get welcome => throw UnimplementedError();

  String get authRegisterPrompt => throw UnimplementedError();

  String get authAlreadyHaveAccount => throw UnimplementedError();

  String get license => throw UnimplementedError();
  ...
  String get currentLanguage => throw UnimplementedError();
...
class _$AppLocalizeEnus extends _$AppLocalizeBase {
  ...
  @override
  String get settings => "Settings (Mock)";
...
class _$AppLocalizeJajp extends _$AppLocalizeBase {
  ...
  @override
  String get welcome => "ホーム画面へようこそ！";

  @override
  String get authRegisterPrompt => "アカウントをお持ちでないですか？登録はこちら";

  @override
  String get authAlreadyHaveAccount => "すでにアカウントをお持ちですか？ログインはこちら";
...
class _$AppLocalizeZhcn extends _$AppLocalizeBase {
  ...
  @override
  String get welcome => "欢迎来到主画面！";

  @override
  String get authRegisterPrompt => "还没有账户？立即注册";

  @override
  String get authAlreadyHaveAccount => "已经有账户了？立即登录";

  @override
  String get license => "注册字体许可证";
...
class _$AppLocalizeKokr extends _$AppLocalizeBase {
  ...
  @override
  String get welcome => "홈 화면에 오신 것을 환영합니다!";

  @override
  String get authRegisterPrompt => "계정이 없으신가요? 회원가입";

  @override
  String get authAlreadyHaveAccount => "이미 계정이 있으신가요? 로그인";

  @override
  String get license => "폰트 라이선스 등록";
